package com.atguigu.common.code;
...
public enum ErrorCode {
    ...
    ERROR_CODE_1112("1112","请求webService内部错误"),

    ERROR_CODE_1113("1113","用户名不能为空"),
    ERROR_CODE_1114("1114","密码不能为空"),
    ERROR_CODE_1115("1115","用户没有注册");
    private String code;
